...
public class InicioEntrenadorFragment extends Fragment {
    ...
    private ImageButton misClientesB;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_inicio_entrenador, null, false);
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        misClientesB = (ImageButton) v.findViewById(R.id.btnMisClientes);
        ...
        misClientesB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
