...
public class EditarEntrenamientoEjerciciosActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        entrenamiento = (Entrenamiento) getIntent().getSerializableExtra(StringsMiguel.LLAVE_ENTRENAMIENTO);
        ...
        listEjercicios = entrenamiento.getEjercicioEntrenamientoList();


        adapterEjercicios = new EjerciciosEntrenamientoAdapter(EditarEntrenamientoEjerciciosActivity.this, listEjercicios, new BtnClickListenerRow() {
            @Override
    ...
    private void adicionarEjercicioDescanso() {
        Intent intent = new Intent(new Intent(EditarEntrenamientoEjerciciosActivity.this, PopCrearEjercicioEntrenamientoDescanso.class));
    ...
    private void finalizar() {
        ...
        if(listEjercicios.isEmpty()){
            ...
            Toast toast = Toast.makeText(getApplicationContext(), StringsMiguel.EDICION_RUTINA_EXITOSA,duracion);
            toast.show();
    ...
    private void buscarEjercicio(){
        Intent intent = new Intent(new Intent(EditarEntrenamientoEjerciciosActivity.this, BuscarEjercicioActivity.class));
    ...
    public void abrirPopUpEditarEjercicioDistancia(EjercicioEntrenamiento ejercicioEntrenamiento){
        Intent intent = new Intent(EditarEntrenamientoEjerciciosActivity.this, PopEditarEjercicioEntrenamientoDistancia.class);
        Bundle bundle = new Bundle();
    ...
    public void abrirPopUpEditarEjercicioDescanso(EjercicioEntrenamiento ejercicioEntrenamiento){
        ...
        Intent intent = new Intent(EditarEntrenamientoEjerciciosActivity.this, PopEditarEjercicioEntrenamientoDescanso.class);
        Bundle bundle = new Bundle();
    ...
    public void abrirPopUpEditarEjercicioTiempo(EjercicioEntrenamiento ejercicioEntrenamiento){
        Intent intent = new Intent(EditarEntrenamientoEjerciciosActivity.this, PopEditarEjercicioEntrenamientoTiempo.class);
        Bundle bundle = new Bundle();
    ...
    public void abrirPopUpEditarEjercicioRepeticiones(EjercicioEntrenamiento ejercicioEntrenamiento){
        Intent intent = new Intent(EditarEntrenamientoEjerciciosActivity.this, PopEditarEjercicioEntrenamientoRepeticion.class);
        Bundle bundle = new Bundle();
