...
public class PopCrearEjercicioSesionRepeticionEditar extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ejercicio = (EjercicioRepeticiones) bundle.getSerializable("ejercicioSesion");
    ...
    private void verInfo() {
        Intent inten = new Intent(PopCrearEjercicioSesionRepeticionEditar.this, InformacionEjercicioActivity.class);
